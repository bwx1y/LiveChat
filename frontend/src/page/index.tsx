...
import {type AuthResponse, type LoginRequest, LoginSchema} from "@/model/auth-model.ts";
...
const IndexPage = () => {
    ...
    const submitForm = async (values: LoginRequest, {setSubmitting}: FormikHelpers<LoginRequest>) => {
        const res = await  apiService.post<AuthResponse, LoginRequest>("Auth/Login",{
            key: null,
            body: values
        })
        setSubmitting(false);
